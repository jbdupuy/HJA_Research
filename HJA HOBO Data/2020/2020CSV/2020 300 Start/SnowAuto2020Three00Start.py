...
def timeTemp(listName):
    ...
    # for i in range(5):
        ...
        if timeList[1][6]=="2":
            ...
            timeList[1]=timeList[1].replace("2019","19")
        if timeList[1].endswith("3:00:12 AM")==True or timeList[1].endswith("3:00:00 AM")==True or timeList[1].endswith("3:00")==True:
            timeList[1]=timeList[1][0:9]+"03:00"
        if timeList[1].endswith("9:00:12 AM")==True or timeList[1].endswith("9:00:00 AM")==True or timeList[1].endswith("9:00")==True:
            timeList[1]=timeList[1][0:9]+"09:00"
        if timeList[1].endswith("3:00:12 PM")==True or timeList[1].endswith("3:00:00 PM")==True or timeList[1].endswith("15:00")==True:
            timeList[1]=timeList[1][0:9]+"15:00"
        if timeList[1].endswith("9:00:12 PM")==True or timeList[1].endswith("9:00:00 PM")==True or timeList[1].endswith("21:00")==True:
            timeList[1]=timeList[1][0:9]+"21:00"
        #print(timeList[1])
        #print(timeList[1])
        timeTemp=[]
...
def dateIndex(listName):
    ...
    #print(datesOnly)
    MarTwenty=datesOnly.index('03/21/20 03:00')
    JanFirst=datesOnly.index('01/01/20 03:00')
