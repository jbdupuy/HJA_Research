...
def timeTemp(listName):
    ...
    #for i in range(5):
        ...
        #print("3,", timeList[1])
        if timeList[1].endswith("3:00:00 AM")==True or timeList[1].endswith("3:00:12 AM")==True or timeList[1].endswith("3:00")==True:
            timeList[1]=timeList[1][0:6]+"03:00"
        if timeList[1].endswith("9:00:00 AM")==True or timeList[1].endswith("9:00:12 AM")==True or timeList[1].endswith("9:00")==True:
            timeList[1]=timeList[1][0:6]+"09:00"
        if timeList[1].endswith("3:00:00 PM")==True or timeList[1].endswith("3:00:12 PM")==True or timeList[1].endswith("15:00:00")==True:
            timeList[1]=timeList[1][0:6]+"15:00"
        if timeList[1].endswith("9:00:00 PM")==True or timeList[1].endswith("9:00:12 PM")==True or timeList[1].endswith("21:00:00")==True:
...
def dateIndex(listName):
    ...
    OctFirst=datesOnly.index('10/16 03:00')
...
def main(fileName):
    ...
    JanFirst=dateIdx[1]
    OctFirst=dateIdx[2]
    FinalZeroOne=snowNoSnow(timeTempsWithYear,OctFirst)[0]
    ...
    for i in range(len(timesYN)):
        ...
        if timesYN[i][0].endswith("03/20/20 15:00"):
            NineList.append("This is the beginning of the snow season")
        if timesYN[i][0].endswith("06/30/20 15:00"):
