...
def dateIndex(listName):
    ...
    if datesOnly.index('03/21 03:00') == None:
        print("March 21 does not exist for this file. It does not cover the entire snow season!")
    else:
        MarTwenty=datesOnly.index('03/21 03:00')
    
    if datesOnly.index('10/01 03:00') == None:
        print("October 1 does not exist for this file - probably not an issue.")
        OctFirst=datesOnly[0]
    else:
        OctFirst=datesOnly.index('10/01 03:00')

    if datesOnly.index('01/01 03:00') == None:
        print("January 1 does not exist for this file - be careful.")
        JanFirst = datesOnly[OctFirst + 1]
    else:
