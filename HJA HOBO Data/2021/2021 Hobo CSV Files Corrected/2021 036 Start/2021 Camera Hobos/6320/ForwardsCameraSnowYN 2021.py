...
def timeTemp(listName):
    ...
    for i in range(len(listName)): #-1?
        ...
        if timeList[1][6]=="2":
            ...
            #print(slashyear)
            timeList[1]=timeList[1].replace(slashyear,"")
        if timeList[1].endswith("12:36 AM")==True or timeList[1].endswith("12:36:00 AM")==True or timeList[1].endswith("0:36")==True:
            timeList[1]=timeList[1][0:6]+"00:36"
        if timeList[1].endswith("6:36 AM")==True or timeList[1].endswith("6:36:00 AM")==True or timeList[1].endswith("6:36")==True:
            timeList[1]=timeList[1][0:6]+"06:36"
        if timeList[1].endswith("12:36 PM")==True or timeList[1].endswith("12:36:00 PM")==True or timeList[1].endswith("12:36")==True:
            timeList[1]=timeList[1][0:6]+"12:36"
        if timeList[1].endswith("6:36 PM")==True or timeList[1].endswith("6:36:00 PM")==True or timeList[1].endswith("18:36")==True:
...
def main(fileName):
    ...
    for i in range(len(timesYN)):
        ...
        if timesYN[i][0].endswith("03/21/21 00:36"):
            NineList.append("This is the beginning of the snow season")
        if timesYN[i][0].endswith("06/30/21 12:36"):
