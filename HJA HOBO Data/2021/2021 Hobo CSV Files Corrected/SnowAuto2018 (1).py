...
# JBD - fullList appears to cause the problem
...
def timeTemp(listName):
    ...
    for i in range(len(listName)): #-1?
        ...
        #print(timeList[1])
        if timeList[1][6]=="2":
            timeList[1]=timeList[1].replace("2018","18")
            timeList[1]=timeList[1].replace("2017","17")
...
def dateIndex(listName):
    ...
    #print(datesOnly)
    MarTwenty=datesOnly.index('03/21/18 03:00')
    JanFirst=datesOnly.index('01/01/18 03:00')
