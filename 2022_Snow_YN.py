"""
Snow Ranges
Creates 2 lists: one Snow YN looking 3 data points into the future, 1 looking 3 data points into the past
...
Produces a list of 0s and 1s that can be copied and pasted based on dates
